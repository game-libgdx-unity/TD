...
public class BuildScript
{
	...
	public static void BuildAssetBundles(BuildAssetBundleOptions buildAssetBundleOption)
	{
		...
		BuildPipeline.BuildAssetBundles (outputPath, buildAssetBundleOption, EditorUserBuildSettings.activeBuildTarget);
	}

	public static void BuildPlayer(BuildAssetBundleOptions buildAssetBundleOption)
	{
		...
		BuildScript.BuildAssetBundles(buildAssetBundleOption);
